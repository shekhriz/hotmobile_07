...
import {NavParams,ViewController,IonicPage, NavController,MenuController,LoadingController ,ModalController } from 'ionic-angular';
...
export class DatePickerPage {
  ...
  dismiss() {
     ...
     this.navCtrl.push(SelectCandidateDbModalPage,{reqId:this.reqId,selecteddetails:this.selecteddetails,time:`${this.hour}:${this.minute} ${this.ampm}`});
    console.log('time',`${this.hour}:${this.minute} ${this.ampm}`);
