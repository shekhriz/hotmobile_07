...
/**
 * Generated class for the CreateCandidateSidePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-create-candidate-side',
  templateUrl: 'create-candidate-side.html',
})
export class CreateCandidateSidePage {
  candidate:any;
  ...
  constructor(public navCtrl: NavController, 
    ...
    public viewCtrl : ViewController,) {
      ...
      this.getSubVendors();
      console.log("lkkkkkkkkkkk", this.getSubVendors);
      this.getRandomId();
  }
  ...
  getRandomId(){
    this.restProvider.getRandomId(this.token)
    .then((res:any)=>{
      this.details = res;
    },errrr=>{
    });
